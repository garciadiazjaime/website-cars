...
const main = async () => {
  const site = {
    url: "https://www.dtvwchicago.com/inventory/used/volkswagen?paymenttype=cash&mileagemax=50000&sorttype=priceltoh&intransit=true&instock=true&inproduction=true",
  };
